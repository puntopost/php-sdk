...
class PickUpDropOffTest extends TestCase
{
    ...
    {
        $address = new Address('06600', 'CDMX', 'Calle 1', null);
    ...
    {
        $pudo = PickUpDropOff::fromArray(['id' => 'X', 'external_id' => 'Y', 'name' => 'Z',
            'description' => '', 'address' => [], 'schedule' => '', 'created_at' => '2024-01-01T00:00:00+00:00']);

        $this->assertFalse($pudo->isEnabled());
    }

    public function testFromArrayEnabledIsFalseWhenNotBool(): void
    {
        $pudo = PickUpDropOff::fromArray(['id' => 'X', 'external_id' => 'Y', 'name' => 'Z',
            'description' => '', 'address' => [], 'schedule' => '', 'enabled' => 1, 'created_at' => '2024-01-01T00:00:00+00:00']);
    ...
    public function testFromArrayWithEmptyArrayDefaultsToEmpty(): void
    {
        ...
        $this->assertFalse($pudo->isEnabled());
        $this->assertInstanceOf(DateTimeImmutable::class, $pudo->getCreatedAt());
    }
    ...
    public function testFromArrayWithWrongTypesDefaultToEmpty(): void
    {
        ...
        $this->assertSame('', $pudo->getExternalId());
        $this->assertSame('', $pudo->getName());
        $this->assertSame('', $pudo->getDescription());
        $this->assertSame('', $pudo->getSchedule());
    }

    public function testFromArrayWithGarbagePayload(): void
    {
        $pudo = PickUpDropOff::fromArray(['unrelated' => 'stuff', 'random_number' => 42]);
