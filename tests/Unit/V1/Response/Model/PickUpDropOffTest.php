...
class PickUpDropOffTest extends TestCase
{
    public function testConstructorStoresValues(): void
    {
        ...
        $scheduleItems = [new ScheduleItem('mon', '09:00', '18:00'), new ScheduleItem('tue', '09:00', '18:00'), new ScheduleItem('wed', '09:00', '18:00'), new ScheduleItem('thu', '09:00', '18:00'), new ScheduleItem('fri', '09:00', '18:00')];
        $pudo = new PickUpDropOff('ID1', 'EXT1', 'pudo', 'PUDO Central', 'Desc', $address, 'Lun-Vie: 09:00-18:00', $scheduleItems, '+523334445556', true, $createdAt);
    ...
    public function testFromArrayWithFullPayload(): void
    {
        ...
        $this->assertSame('Lun-Vie: 09:00-18:00', $pudo->getSchedule());
        $this->assertCount(5, $pudo->getScheduleItems());
