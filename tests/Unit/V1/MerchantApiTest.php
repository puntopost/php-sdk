...
class MerchantApiTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new MerchantApi($this->httpClient, MockHttpClient::BASE_URL);
        ...
        $data = [
            'detail' => [
                ...
                'destination' => [
                    ...
                    'name' => 'PUDO Central', 'description' => 'Punto de entrega central',
                    'address' => ['postal_code' => '06600', 'city' => 'CDMX', 'address' => 'Calle 1 #123', 'coordinate' => ['latitude' => 19.4326, 'longitude' => -99.1332]],
                    'schedule' => 'Lun-Vie: 09:00-18:00', 'schedule_items' => [['day' => 'mon', 'start' => '09:00', 'end' => '18:00'], ['day' => 'tue', 'start' => '09:00', 'end' => '18:00'], ['day' => 'wed', 'start' => '09:00', 'end' => '18:00'], ['day' => 'thu', 'start' => '09:00', 'end' => '18:00'], ['day' => 'fri', 'start' => '09:00', 'end' => '18:00']], 'phone' => '+523334445556', 'enabled' => true, 'created_at' => '2023-01-01T00:00:00+00:00',
                ],
                'created_at' => '2024-01-01T10:00:00+00:00',
                'expire_at' => null,
            ],
    ...
    public function testCreateB2CParcelSuccess(): void
    {
        ...
        $expectedResponse = new ParcelDetailResponse(new Parcel(
            ...
            new Person('Ana', 'Lopez', 'ana@example.com', null, null),
            new PickUpDropOff('PUDO_ORIGIN_001', 'MX002', 'merchant', 'Sucursal Origen', 'Origen', new Address('06600', 'CDMX', 'Calle 2 #456', new Coordinate(19.4326, -99.1332)), 'Lun-Vie: 09:00-18:00', [new ScheduleItem('mon', '09:00', '18:00'), new ScheduleItem('tue', '09:00', '18:00'), new ScheduleItem('wed', '09:00', '18:00'), new ScheduleItem('thu', '09:00', '18:00'), new ScheduleItem('fri', '09:00', '18:00')], '+523334445556', true, Date::from('2023-01-01T00:00:00+00:00')),
            new PickUpDropOff('PUDO_001', 'MX001', 'pudo', 'PUDO Central', 'Punto de entrega central', new Address('44100', 'Guadalajara', 'Calle 1 #123', new Coordinate(20.67, -103.35)), 'Lun-Vie: 09:00-18:00', [new ScheduleItem('mon', '09:00', '18:00'), new ScheduleItem('tue', '09:00', '18:00'), new ScheduleItem('wed', '09:00', '18:00'), new ScheduleItem('thu', '09:00', '18:00'), new ScheduleItem('fri', '09:00', '18:00')], '+523334445556', true, Date::from('2023-01-01T00:00:00+00:00')),
            Date::from('2024-01-01T10:00:00+00:00'),
            null
        ));
    ...
    public function testListPudosWithoutRequestSuccess(): void
    {
        $data = [
            ...
            'next' => 'https://api.example.com/api/merchant/v1/pudos?latitude=19.4326&longitude=-99.1332&cursor=5-0',
        ];
        $response = new HttpResponse(
            200,
            json_encode($data, JSON_THROW_ON_ERROR),
        ...
        $expectedResponse = new PudoListResponse(
            ...
            [
                new PickUpDropOff('PUDO_001', 'MX001', 'pudo', 'PUDO Central', 'Punto de entrega central', new Address('06600', 'CDMX', 'Calle 1 #123', new Coordinate(19.4326, -99.1332)), 'Lun-Vie: 09:00-18:00', [new ScheduleItem('mon', '09:00', '18:00'), new ScheduleItem('tue', '09:00', '18:00'), new ScheduleItem('wed', '09:00', '18:00'), new ScheduleItem('thu', '09:00', '18:00'), new ScheduleItem('fri', '09:00', '18:00')], '+523334445556', true, new DateTimeImmutable('2023-01-01T00:00:00+00:00')),
            ],
            new ListPudosRequest(new \PuntoPost\Sdk\V1\Request\DTO\Coordinate(19.4326, -99.1332), null, null, Pagination::from('5-0'))
        );
    ...
    public function testGetMerchantSuccess(): void
    {
        $data = [
            'detail' => [
                ...
                'pudos' => [
                    ['id' => 'PUDO_001', 'external_id' => 'MX001', 'type' => 'pudo', 'name' => 'Sucursal 1', 'description' => 'Sucursal centro', 'address' => ['postal_code' => '06600', 'city' => 'CDMX', 'address' => 'Calle 1', 'coordinate' => ['latitude' => 19.4326, 'longitude' => -99.1332]], 'schedule' => 'Lun-Vie: 09-18', 'schedule_items' => [['day' => 'mon', 'start' => '09:00', 'end' => '18:00'], ['day' => 'tue', 'start' => '09:00', 'end' => '18:00'], ['day' => 'wed', 'start' => '09:00', 'end' => '18:00'], ['day' => 'thu', 'start' => '09:00', 'end' => '18:00'], ['day' => 'fri', 'start' => '09:00', 'end' => '18:00']], 'phone' => '+523334445556', 'enabled' => true, 'created_at' => '2023-01-01T00:00:00+00:00'],
                ],
            ],
        ];
        $response = new HttpResponse(
        ...
        $expectedResponse = new MerchantDetailResponse(
            new Merchant(
                ...
                [
                    new PickUpDropOff('PUDO_001', 'MX001', 'pudo', 'Sucursal 1', 'Sucursal centro', new Address('06600', 'CDMX', 'Calle 1', new Coordinate(19.4326, -99.1332)), 'Lun-Vie: 09-18', [new ScheduleItem('mon', '09:00', '18:00'), new ScheduleItem('tue', '09:00', '18:00'), new ScheduleItem('wed', '09:00', '18:00'), new ScheduleItem('thu', '09:00', '18:00'), new ScheduleItem('fri', '09:00', '18:00')], '+523334445556', true, new DateTimeImmutable('2023-01-01T00:00:00+00:00')),
                ]
            )
        );
    ...
    public function testGetParcelUnauthorizedWhenNotLoggedIn(): void
    {
        $rawBody = '{"type":"UNAUTHORIZED","title":"Access denied","detail":"You do not have permission to access this resource","instance":"authentication"}';
